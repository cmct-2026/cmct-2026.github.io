...
const Registration = () => {
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
            <h2 style={{ color: '#003366', marginBottom: '40px' }}>Registration</h2>
